...
import static com.cong.wanwu.common.constant.SystemConstants.WANWU_POST_FAVOUR;
...
public class PostFavourServiceImpl extends ServiceImpl<PostFavourMapper, PostFavour>
    ...
    public int doPostFavour(long postId, User loginUser) {
        ...
        return lockService.executeWithLock(WANWU_POST_FAVOUR+userId, 10, TimeUnit.SECONDS, ()->{
            //执行业务逻辑
